...
var $author$project$Accumulate$map = F3(
	function (func, input, acc) {
		map:
		while (true) {
			if (!input.b) {
				return acc;
...
var $author$project$Accumulate$accumulate = F2(
	function (func, input) {
		return $elm$core$List$reverse(
			A3($author$project$Accumulate$map, func, input, _List_Nil));
	});
...
var $author$project$Tests$square = function (x) {
	return x * x;
};
		...
		[
			...
			function (_v0) {
				return A2(
					...
					_List_Nil,
					A2($author$project$Accumulate$accumulate, $author$project$Tests$square, _List_Nil));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'square Accumulate',
			function (_v1) {
				return A2(
					...
					_List_fromArray(
						[1, 4, 9]),
					A2(
						$author$project$Accumulate$accumulate,
						$author$project$Tests$square,
						_List_fromArray(
							[1, 2, 3])));
			}),
			A2(
...
var $author$project$Test$Generated$Main1329749991$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/Carter/Exercism/elm/accumulate/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 344886845904351
	},
...
_Platform_export({'Test':{'Generated':{'Main1329749991':{'init':$author$project$Test$Generated$Main1329749991$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-54182.sock";
