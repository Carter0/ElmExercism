...
var $author$project$Acronym$addChar = F2(
	function (word, acr) {
		var firstChar = $elm$core$String$toUpper(
			A2($elm$core$String$left, 1, word));
		return A2($elm$core$String$append, firstChar, acr);
	});
...
var $author$project$Acronym$abbreviate = function (phrase) {
	...
	return A3($elm$core$List$foldr, $author$project$Acronym$addChar, '', words);
};
...
var $author$project$Test$Generated$Main2600018093$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/Carter/Exercism/elm/acronym/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 226688003137547
	},
...
_Platform_export({'Test':{'Generated':{'Main2600018093':{'init':$author$project$Test$Generated$Main2600018093$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-63760.sock";
