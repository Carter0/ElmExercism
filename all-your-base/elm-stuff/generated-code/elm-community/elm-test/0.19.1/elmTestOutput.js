...
var $author$project$AllYourBase$badConditions = F3(
	function (inBase, digits, outBase) {
		return $elm$core$List$isEmpty(
			...
			$elm$core$List$any,
			function (x) {
				return _Utils_cmp(x, inBase) > -1;
			},
			digits))));
	});
var $elm$core$Basics$pow = _Basics_pow;
var $author$project$AllYourBase$base10Conversion = F4(
	function (position, base, digits, sum) {
		base10Conversion:
		while (true) {
			if (!digits.b) {
				return sum;
				...
				var $temp$position = position - 1,
					$temp$base = base,
					$temp$digits = xs,
					$temp$sum = sum + (x * A2($elm$core$Basics$pow, base, position));
				position = $temp$position;
				base = $temp$base;
				digits = $temp$digits;
				sum = $temp$sum;
				continue base10Conversion;
			}
		}
	});
var $elm$core$Basics$modBy = _Basics_modBy;
var $author$project$AllYourBase$outBaseConversion = F3(
	function (outBase, acc, number) {
		outBaseConversion:
		while (true) {
			if (!number) {
				return acc;
			} else {
				var $temp$outBase = outBase,
					$temp$acc = A2(
					$elm$core$List$cons,
					A2($elm$core$Basics$modBy, outBase, number),
					acc),
					$temp$number = (number / outBase) | 0;
				outBase = $temp$outBase;
				acc = $temp$acc;
				number = $temp$number;
				continue outBaseConversion;
			}
		}
	});
var $author$project$AllYourBase$rebase = F3(
	function (inBase, digits, outBase) {
		return A3($author$project$AllYourBase$badConditions, inBase, digits, outBase) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(
			A3(
				$author$project$AllYourBase$outBaseConversion,
				outBase,
				_List_Nil,
				A4(
					$author$project$AllYourBase$base10Conversion,
					$elm$core$List$length(digits) - 1,
					inBase,
					digits,
					0)));
	});
		...
		[
				...
				return A2(
					...
					$elm$core$Maybe$Just(
						_List_fromArray(
							[1])),
					A3(
						$author$project$AllYourBase$rebase,
						2,
						_List_fromArray(
							[1]),
						10));
			...
			function (_v8) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					A3($author$project$AllYourBase$rebase, 2, _List_Nil, 10));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'single zero',
			...
			function (_v12) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					A3($author$project$AllYourBase$rebase, 1, _List_Nil, 10));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'first base is zero',
			function (_v13) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					A3($author$project$AllYourBase$rebase, 0, _List_Nil, 10));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v17) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					A3($author$project$AllYourBase$rebase, 10, _List_Nil, 1));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'second base is zero',
...
var $author$project$Test$Generated$Main2094173289$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/Carter/Exercism/elm/all-your-base/tests/Tests.elm']),
		processes: 8,
...
_Platform_export({'Test':{'Generated':{'Main2094173289':{'init':$author$project$Test$Generated$Main2094173289$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-76979.sock";
