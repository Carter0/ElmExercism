...
var $author$project$Anagram$changeString = function (word) {
	return $elm$core$List$sort(
		$elm$core$String$toList(
			$elm$core$String$toLower(word)));
};
var $author$project$Anagram$isAnagramOf = F2(
	function (word, candidate) {
		return _Utils_eq(
			$elm$core$String$toLower(word),
			$elm$core$String$toLower(candidate)) ? $elm$core$Maybe$Nothing : (_Utils_eq(
			$author$project$Anagram$changeString(word),
			$author$project$Anagram$changeString(candidate)) ? $elm$core$Maybe$Just(candidate) : $elm$core$Maybe$Nothing);
	});
var $author$project$Anagram$detect = F2(
	function (word, candidates) {
		return A2(
			$elm$core$List$filterMap,
			$author$project$Anagram$isAnagramOf(word),
			candidates);
	});
...
var $author$project$Test$Generated$Main3639311522$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/Carter/Exercism/elm/anagram/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 209863035999699
	},
...
_Platform_export({'Test':{'Generated':{'Main3639311522':{'init':$author$project$Test$Generated$Main3639311522$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-83132.sock";
