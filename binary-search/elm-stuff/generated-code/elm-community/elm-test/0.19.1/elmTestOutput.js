...
var $author$project$BinarySearch$binarySearch = F3(
	function (target, xs, indexCounter) {
		binarySearch:
		while (true) {
			var length = $elm$core$Array$length(xs);
			var midIndex = (length / 2) | 0;
			var midValue = A2(
				$elm$core$Maybe$withDefault,
				0,
				A2($elm$core$Array$get, midIndex, xs));
			if (_Utils_eq(midValue, target)) {
				return $elm$core$Maybe$Just(indexCounter + midIndex);
			} else {
				if (length === 1) {
					return $elm$core$Maybe$Nothing;
				} else {
					if (_Utils_cmp(midValue, target) > 0) {
						var $temp$target = target,
							$temp$xs = A3($elm$core$Array$slice, 0, midIndex, xs),
							$temp$indexCounter = indexCounter;
						target = $temp$target;
						xs = $temp$xs;
						indexCounter = $temp$indexCounter;
						continue binarySearch;
					} else {
						var $temp$target = target,
							$temp$xs = A3($elm$core$Array$slice, midIndex, length, xs),
							$temp$indexCounter = indexCounter + midIndex;
						target = $temp$target;
						xs = $temp$xs;
						indexCounter = $temp$indexCounter;
						continue binarySearch;
...
var $author$project$BinarySearch$find = F2(
	function (target, xs) {
		return $elm$core$Array$isEmpty(xs) ? $elm$core$Maybe$Nothing : A3($author$project$BinarySearch$binarySearch, target, xs, 0);
	});
		...
		[
			...
			function (_v0) {
				return A2(
					...
					A2(
						$author$project$BinarySearch$find,
						6,
			...
			function (_v8) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					A2($author$project$BinarySearch$find, 1, $elm$core$Array$empty));
			})
		]));
var $author$project$Test$Generated$Main1577298158$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/Carter/Exercism/elm/binary-search/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 117908072840551
	},
...
_Platform_export({'Test':{'Generated':{'Main1577298158':{'init':$author$project$Test$Generated$Main1577298158$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-18867.sock";
