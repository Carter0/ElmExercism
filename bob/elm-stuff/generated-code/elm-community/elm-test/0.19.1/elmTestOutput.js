...
var $author$project$Bob$hey = function (remark) {
	var realRemark = $elm$core$String$trimRight(remark);
	var isQuestion = A2($elm$core$String$endsWith, '?', realRemark);
	var isNotEmpty = !$elm$core$String$isEmpty(realRemark);
	var containsCharacterCaps = (!A2($elm$core$String$any, $elm$core$Char$isLower, realRemark)) && A2($elm$core$String$any, $elm$core$Char$isAlpha, realRemark);
	if (isNotEmpty) {
		var _v0 = _Utils_Tuple2(isQuestion, containsCharacterCaps);
		if (_v0.a) {
			if (_v0.b) {
		...
		[
			...
			function (_v28) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'Whatever.',
					$author$project$Bob$hey('你好，鮑勃！'));
			})
		]));
var $author$project$Test$Generated$Main1567308540$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/Carter/Exercism/elm/bob/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 350649788221767
	},
...
_Platform_export({'Test':{'Generated':{'Main1567308540':{'init':$author$project$Test$Generated$Main1567308540$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-11059.sock";
