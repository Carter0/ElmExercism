...
var $author$project$CollatzConjecture$collatzHelper = F2(
		...
		while (true) {
			if (start === 1) {
				...
				if (!A2($elm$core$Basics$modBy, 2, start)) {
					var $temp$start = (start / 2) | 0,
						$temp$counter = counter + 1;
					start = $temp$start;
					counter = $temp$counter;
					continue collatzHelper;
				} else {
					var $temp$start = (3 * start) + 1,
						$temp$counter = counter + 1;
					start = $temp$start;
					counter = $temp$counter;
					continue collatzHelper;
...
var $author$project$CollatzConjecture$collatz = function (start) {
	return (start <= 0) ? $elm$core$Result$Err('Only positive numbers are allowed') : $elm$core$Result$Ok(
		A2($author$project$CollatzConjecture$collatzHelper, start, 0));
};
...
var $author$project$Test$Generated$Main2016348921$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/Carter/Exercism/elm/collatz-conjecture/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 204531910536667
	},
...
_Platform_export({'Test':{'Generated':{'Main2016348921':{'init':$author$project$Test$Generated$Main2016348921$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-54571.sock";
