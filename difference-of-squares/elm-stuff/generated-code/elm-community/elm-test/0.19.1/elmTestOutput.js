...
var $author$project$DifferenceOfSquares$squareOfSum = function (n) {
	return A2($elm$core$Basics$pow, ((n * (n + 1)) / 2) | 0, 2);
};
var $author$project$DifferenceOfSquares$sumOfSquares = function (n) {
	return (((n * (n + 1)) * ((2 * n) + 1)) / 6) | 0;
};
var $author$project$DifferenceOfSquares$difference = function (n) {
	return $elm$core$Basics$abs(
		$author$project$DifferenceOfSquares$sumOfSquares(n) - $author$project$DifferenceOfSquares$squareOfSum(n));
};
				...
				[
					...
					function (_v0) {
						return A2(
							...
							225,
							$author$project$DifferenceOfSquares$squareOfSum(5));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'square of sum 10',
					function (_v1) {
						return A2(
							$elm_explorations$test$Expect$equal,
							3025,
							$author$project$DifferenceOfSquares$squareOfSum(10));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'square of sum 100',
					function (_v2) {
						return A2(
							$elm_explorations$test$Expect$equal,
							25502500,
							$author$project$DifferenceOfSquares$squareOfSum(100));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
				...
				[
					...
					function (_v3) {
						return A2(
							$elm_explorations$test$Expect$equal,
							55,
							$author$project$DifferenceOfSquares$sumOfSquares(5));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'sum of squares 10',
					function (_v4) {
						return A2(
							$elm_explorations$test$Expect$equal,
							385,
							$author$project$DifferenceOfSquares$sumOfSquares(10));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'sum of squares 100',
					function (_v5) {
						return A2(
							$elm_explorations$test$Expect$equal,
							338350,
							$author$project$DifferenceOfSquares$sumOfSquares(100));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
				...
				[
					...
					function (_v6) {
						return A2(
							$elm_explorations$test$Expect$equal,
							0,
							$author$project$DifferenceOfSquares$difference(0));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v7) {
						return A2(
							$elm_explorations$test$Expect$equal,
							170,
							$author$project$DifferenceOfSquares$difference(5));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v8) {
						return A2(
							$elm_explorations$test$Expect$equal,
							2640,
							$author$project$DifferenceOfSquares$difference(10));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v9) {
						return A2(
							$elm_explorations$test$Expect$equal,
							25164150,
							$author$project$DifferenceOfSquares$difference(100));
					})
				]))
		]));
var $author$project$Test$Generated$Main2034645836$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/Carter/Exercism/elm/difference-of-squares/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 147531134840205
	},
...
_Platform_export({'Test':{'Generated':{'Main2034645836':{'init':$author$project$Test$Generated$Main2034645836$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-17345.sock";
