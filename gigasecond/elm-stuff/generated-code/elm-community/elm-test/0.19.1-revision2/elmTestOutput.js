...
var $author$project$Gigasecond$add = function (timestamp) {
	return $elm$time$Time$millisToPosix(
		$elm$time$Time$posixToMillis(timestamp) + 1000000000000);
};
...
var $author$project$Test$Generated$Main10855406$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/carterweinberg/Exercism/elm/gigasecond/tests/Tests.elm']),
		processes: 12,
...
_Platform_export({'Test':{'Generated':{'Main10855406':{'init':$author$project$Test$Generated$Main10855406$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-6900.sock";
