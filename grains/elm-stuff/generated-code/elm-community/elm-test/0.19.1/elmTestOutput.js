...
var $author$project$Grains$squareHelper = F2(
	function (acc, countdown) {
		squareHelper:
		while (true) {
			if (countdown === 1) {
				return acc;
				...
				var $temp$acc = acc * 2,
					$temp$countdown = countdown - 1;
				acc = $temp$acc;
				countdown = $temp$countdown;
				continue squareHelper;
			}
		}
	});
var $author$project$Grains$square = function (n) {
	return (n <= 0) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(
		A2($author$project$Grains$squareHelper, 1, n));
};
				...
				[
					...
					function (_v0) {
						return A2(
							...
							$author$project$Grains$square(1));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'of 2',
					function (_v1) {
						return A2(
							...
							$author$project$Grains$square(2));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'of 3',
					function (_v2) {
						return A2(
							...
							$author$project$Grains$square(3));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'of 4',
					function (_v3) {
						return A2(
							...
							$author$project$Grains$square(4));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'of 16',
					function (_v4) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$elm$core$Maybe$Just(32768),
							$author$project$Grains$square(16));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'of 32',
					function (_v5) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$elm$core$Maybe$Just(2147483648),
							$author$project$Grains$square(32));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v6) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$elm$core$Maybe$Nothing,
							$author$project$Grains$square(0));
					}),
					A2(
					$elm_explorations$test$Test$test,
...
var $author$project$Test$Generated$Main352934294$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/Carter/Exercism/elm/grains/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 206181571373906
	},
...
_Platform_export({'Test':{'Generated':{'Main352934294':{'init':$author$project$Test$Generated$Main352934294$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-54139.sock";
