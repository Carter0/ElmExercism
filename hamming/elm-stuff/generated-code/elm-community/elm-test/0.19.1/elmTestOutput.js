...
var $author$project$Hamming$difference = F2(
	function (left, right) {
		return (!_Utils_eq(left, right)) ? 1 : 0;
	});
var $elm$core$List$sum = function (numbers) {
	return A3($elm$core$List$foldl, $elm$core$Basics$add, 0, numbers);
};
var $author$project$Hamming$hamming = F2(
	function (left, right) {
		return $elm$core$List$sum(
			A3(
				$elm$core$List$map2,
				$author$project$Hamming$difference,
				$elm$core$String$toList(left),
				$elm$core$String$toList(right)));
	});
var $elm$core$String$length = _String_length;
var $author$project$Hamming$distance = F2(
	function (left, right) {
		return (!_Utils_eq(
			$elm$core$String$length(left),
			$elm$core$String$length(right))) ? $elm$core$Result$Err('left and right strands must be of equal length') : $elm$core$Result$Ok(
			A2($author$project$Hamming$hamming, left, right));
	});
		...
		[
			...
			function (_v0) {
				return A2(
					...
					A2($author$project$Hamming$distance, 'A', 'A'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Ok(0),
					A2($author$project$Hamming$distance, 'GGACTGA', 'GGACTGA'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v2) {
				return A2(
					...
					A2($author$project$Hamming$distance, 'A', 'G'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v3) {
				return A2(
					...
					A2($author$project$Hamming$distance, 'AG', 'CT'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v4) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Ok(1),
					A2($author$project$Hamming$distance, 'AT', 'CT'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'small distance',
			function (_v5) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Ok(1),
					A2($author$project$Hamming$distance, 'GGACG', 'GGTCG'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v6) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Ok(2),
					A2($author$project$Hamming$distance, 'ACCAGGG', 'ACTATGG'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v7) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Ok(1),
					A2($author$project$Hamming$distance, 'AGA', 'AGG'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v8) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Ok(1),
					A2($author$project$Hamming$distance, 'AGG', 'AGA'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'large distance',
			function (_v9) {
				return A2(
					...
					A2($author$project$Hamming$distance, 'GATACA', 'GCATAA'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v10) {
				return A2(
					...
					A2($author$project$Hamming$distance, 'GGACGGATTCTG', 'AGGACGGATTCT'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'empty strands',
			function (_v11) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Ok(0),
					A2($author$project$Hamming$distance, '', ''));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v12) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Err('left and right strands must be of equal length'),
					A2($author$project$Hamming$distance, 'AATG', 'AAA'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v13) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Err('left and right strands must be of equal length'),
					A2($author$project$Hamming$distance, 'ATA', 'AGTG'));
			})
		]));
var $author$project$Test$Generated$Main2151849748$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/Carter/Exercism/elm/hamming/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 224823861857843
	},
...
_Platform_export({'Test':{'Generated':{'Main2151849748':{'init':$author$project$Test$Generated$Main2151849748$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-19567.sock";
