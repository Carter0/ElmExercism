...
var $author$project$LargestSeriesProduct$createSeriesList = F3(
	function (length, acc, series) {
		createSeriesList:
		while (true) {
			if ($elm$core$List$isEmpty(series)) {
				return A2(
					$elm$core$List$filter,
					function (x) {
						return _Utils_eq(
				...
				var $temp$length = length,
					$temp$acc = A2(
					$elm$core$List$cons,
					A2($elm$core$List$take, length, series),
					acc),
					$temp$series = A2($elm$core$List$drop, 1, series);
				length = $temp$length;
				acc = $temp$acc;
				series = $temp$series;
				continue createSeriesList;
			}
		}
	});
...
var $author$project$LargestSeriesProduct$largestProduct = F2(
	function (length, series) {
		var return1 = (!length) && $elm$core$String$isEmpty(series);
		var inputList = A2(
			$elm$core$List$map,
			function (x) {
				return $elm$core$Char$toCode(x) - $elm$core$Char$toCode(
					_Utils_chr('0'));
			},
			$elm$core$String$toList(series));
		var returnNothing = ((!(!length)) && $elm$core$List$isEmpty(inputList)) || (!A2(
			$elm$core$List$all,
			$elm$core$Char$isDigit,
			$elm$core$String$toList(series)));
		return returnNothing ? $elm$core$Maybe$Nothing : (return1 ? $elm$core$Maybe$Just(1) : $elm$core$List$maximum(
			A2(
				$elm$core$List$map,
				$elm$core$List$product,
				A3($author$project$LargestSeriesProduct$createSeriesList, length, _List_Nil, inputList))));
	});
		...
		[
			...
			function (_v0) {
				return A2(
					...
					A2($author$project$LargestSeriesProduct$largestProduct, 2, '0123456789'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v1) {
				return A2(
					...
					A2($author$project$LargestSeriesProduct$largestProduct, 2, '576802143'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v2) {
				return A2(
					...
					A2($author$project$LargestSeriesProduct$largestProduct, 2, '29'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v3) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Just(504),
					A2($author$project$LargestSeriesProduct$largestProduct, 3, '0123456789'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v4) {
				return A2(
					...
					A2($author$project$LargestSeriesProduct$largestProduct, 3, '1027839564'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v5) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Just(15120),
					A2($author$project$LargestSeriesProduct$largestProduct, 5, '0123456789'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v6) {
				return A2(
					...
					A2($author$project$LargestSeriesProduct$largestProduct, 6, '73167176531330624919225119674426574742355349194934'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v7) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Just(28350),
					A2($author$project$LargestSeriesProduct$largestProduct, 6, '52677741234314237566414902593461595376319419139427'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v8) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Just(23514624000),
					A2($author$project$LargestSeriesProduct$largestProduct, 13, ''));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v9) {
				return A2(
					...
					A2($author$project$LargestSeriesProduct$largestProduct, 2, '0000'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v10) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Just(0),
					A2($author$project$LargestSeriesProduct$largestProduct, 3, '99099'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v11) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					A2($author$project$LargestSeriesProduct$largestProduct, 4, '123'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v12) {
				return A2(
					...
					A2($author$project$LargestSeriesProduct$largestProduct, 0, ''));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v13) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Just(1),
					A2($author$project$LargestSeriesProduct$largestProduct, 0, '123'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v14) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					A2($author$project$LargestSeriesProduct$largestProduct, 1, ''));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v15) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					A2($author$project$LargestSeriesProduct$largestProduct, 2, '1234a5'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v16) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					A2($author$project$LargestSeriesProduct$largestProduct, -1, '12345'));
			})
		]));
var $author$project$Test$Generated$Main1744097410$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/carterweinberg/Exercism/elm/largest-series-product/tests/Tests.elm']),
		processes: 12,
...
_Platform_export({'Test':{'Generated':{'Main1744097410':{'init':$author$project$Test$Generated$Main1744097410$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-5202.sock";
