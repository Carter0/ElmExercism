...
var $author$project$ListOps$foldHelper = F3(
	function (f, acc, list) {
		foldHelper:
		while (true) {
			if (!list.b) {
...
var $author$project$ListOps$reverseHelper = F2(
	function (list, acc) {
		reverseHelper:
		while (true) {
			if (!list.b) {
...
var $author$project$ListOps$reverse = function (list) {
	return A2($author$project$ListOps$reverseHelper, list, _List_Nil);
};
var $author$project$ListOps$foldr = F3(
	function (f, acc, list) {
		return A3(
			$author$project$ListOps$foldHelper,
			f,
			acc,
			$author$project$ListOps$reverse(list));
	});
var $author$project$ListOps$append = F2(
	function (xs, ys) {
		if (!ys.b) {
			return xs;
		} else {
			return A3($author$project$ListOps$foldr, $elm$core$List$cons, ys, xs);
		}
	});
var $author$project$ListOps$concat = function (list) {
	return A3($author$project$ListOps$foldr, $author$project$ListOps$append, _List_Nil, list);
};
...
var $author$project$ListOps$filter = F2(
	function (f, list) {
		var foldrFunction = F2(
			function (x, acc) {
				return f(x) ? A2($elm$core$List$cons, x, acc) : acc;
			});
		return A3($author$project$ListOps$foldr, foldrFunction, _List_Nil, list);
	});
var $author$project$ListOps$foldl = F3(
	function (f, acc, list) {
		foldl:
		while (true) {
			if (!list.b) {
...
var $author$project$ListOps$lengthHelper = F2(
	function (list, acc) {
		lengthHelper:
		while (true) {
			if (!list.b) {
...
var $author$project$ListOps$length = function (list) {
	return A2($author$project$ListOps$lengthHelper, list, 0);
};
var $author$project$ListOps$mapHelper = F3(
	function (f, list, acc) {
		mapHelper:
		while (true) {
			if (!list.b) {
...
var $author$project$ListOps$map = F2(
	function (f, list) {
		return A3(
			$author$project$ListOps$mapHelper,
			f,
			$author$project$ListOps$reverse(list),
			_List_Nil);
	});
				...
				[
					...
					function (_v0) {
						return A2(
							...
							0,
							$author$project$ListOps$length(_List_Nil));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'non-empty list',
				...
				[
					...
					function (_v2) {
						return A2(
							$elm_explorations$test$Expect$equal,
							_List_Nil,
							$author$project$ListOps$reverse(_List_Nil));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'non-empty list',
					function (_v3) {
						return A2(
							...
							_List_fromArray(
								[4, 3, 2, 1]),
							$author$project$ListOps$reverse(
								A2($elm$core$List$range, 1, 4)));
					})
				])),
			A2(
				...
				[
					...
					function (_v9) {
						return A2(
							$elm_explorations$test$Expect$equal,
							0,
							A3($author$project$ListOps$foldl, $elm$core$Basics$add, 0, _List_Nil));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'non-empty list',
				...
				[
					...
					function (_v12) {
						return A2(
							$elm_explorations$test$Expect$equal,
							0,
							A3($author$project$ListOps$foldr, $elm$core$Basics$add, 0, _List_Nil));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'non-empty list',
				...
				[
					...
					function (_v15) {
						return A2(
							$elm_explorations$test$Expect$equal,
							_List_Nil,
							A2($author$project$ListOps$append, _List_Nil, _List_Nil));
					}),
					A2(
					$elm_explorations$test$Test$test,
				...
				[
					...
					function (_v19) {
						return A2(
							$elm_explorations$test$Expect$equal,
							_List_Nil,
							$author$project$ListOps$concat(_List_Nil));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'list of lists',
					function (_v20) {
						return A2(
							...
							$author$project$ListOps$concat(
								_List_fromArray(
									[
										A2($elm$core$List$range, 1, 3),
										_List_Nil,
										A2($elm$core$List$range, 4, 7),
										A2($elm$core$List$range, 8, 10)
									])));
					})
				]))
		]));
var $author$project$Test$Generated$Main514711908$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/carterweinberg/Exercism/elm/list-ops/tests/Tests.elm']),
		processes: 12,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 162642289603974
	},
...
_Platform_export({'Test':{'Generated':{'Main514711908':{'init':$author$project$Test$Generated$Main514711908$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-27253.sock";
