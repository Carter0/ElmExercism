...
var $author$project$PhoneNumber$badConditions = function (phoneNumber) {
	var fourth = A2($elm$core$String$left, 4, phoneNumber);
	return (A2($elm$core$String$startsWith, '0', phoneNumber) || (A2($elm$core$String$startsWith, '1', phoneNumber) || (A2($elm$core$String$endsWith, '0', fourth) || A2($elm$core$String$endsWith, '1', fourth)))) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(phoneNumber);
};
...
var $author$project$PhoneNumber$phoneNumberCleaning = function (phoneNumber) {
	var returnNumber = A2($elm$core$String$filter, $elm$core$Char$isDigit, phoneNumber);
	return (A2($elm$core$String$startsWith, '1', returnNumber) && ($elm$core$String$length(returnNumber) === 11)) ? $elm$core$Maybe$Just(
		A2($elm$core$String$dropLeft, 1, returnNumber)) : (($elm$core$String$length(returnNumber) === 10) ? $elm$core$Maybe$Just(returnNumber) : $elm$core$Maybe$Nothing);
};
var $author$project$PhoneNumber$getNumber = function (phoneNumber) {
	return A2(
		$elm$core$Maybe$andThen,
		$author$project$PhoneNumber$badConditions,
		$author$project$PhoneNumber$phoneNumberCleaning(phoneNumber));
};
		...
		[
			...
			function (_v0) {
				return A2(
					...
					$elm$core$Maybe$Just('2234567890'),
					$author$project$PhoneNumber$getNumber('(223) 456-7890'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v3) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					$author$project$PhoneNumber$getNumber('223456789'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v4) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					$author$project$PhoneNumber$getNumber('22234567890'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v5) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Just('2234567890'),
					$author$project$PhoneNumber$getNumber('12234567890'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v6) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Just('2234567890'),
					$author$project$PhoneNumber$getNumber('+1 (223) 456-7890'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v7) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					$author$project$PhoneNumber$getNumber('321234567890'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v8) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					$author$project$PhoneNumber$getNumber('123-abc-7890'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v9) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					$author$project$PhoneNumber$getNumber('123-@:!-7890'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v10) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					$author$project$PhoneNumber$getNumber('(023) 456-7890'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v11) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					$author$project$PhoneNumber$getNumber('(123) 456-7890'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v12) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					$author$project$PhoneNumber$getNumber('(223) 056-7890'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v13) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					$author$project$PhoneNumber$getNumber('(223) 156-7890'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v14) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					$author$project$PhoneNumber$getNumber('1 (023) 456-7890'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v15) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					$author$project$PhoneNumber$getNumber('1 (123) 456-7890'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v16) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					$author$project$PhoneNumber$getNumber('1 (223) 056-7890'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v17) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					$author$project$PhoneNumber$getNumber('1 (223) 156-7890'));
			})
		]));
var $author$project$Test$Generated$Main3327425325$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/Carter/Exercism/elm/phone-number/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 109053844622484
	},
...
_Platform_export({'Test':{'Generated':{'Main3327425325':{'init':$author$project$Test$Generated$Main3327425325$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-71601.sock";
