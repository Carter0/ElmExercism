...
var $author$project$SumOfMultiples$generateMultiples = F2(
	function (limit, n) {
		return A2(
			$elm$core$List$map,
			$elm$core$Basics$mul(n),
			A2($elm$core$List$range, 1, ((limit - 1) / n) | 0));
	});
var $author$project$SumOfMultiples$removeDups = F2(
	function (divisors, limit) {
		return $elm$core$Set$fromList(
			A2(
				$elm$core$List$concatMap,
				$author$project$SumOfMultiples$generateMultiples(limit),
				divisors));
	});
var $author$project$SumOfMultiples$sumOfMultiples = F2(
	function (divisors, limit) {
		return A3(
			...
			$elm$core$Basics$add,
			0,
			A2($author$project$SumOfMultiples$removeDups, divisors, limit));
	});
		...
		[
			...
			function (_v0) {
				return A2(
					...
					45,
					A2(
						$author$project$SumOfMultiples$sumOfMultiples,
						_List_fromArray(
							[3, 5]),
						15));
			}),
...
var $author$project$Test$Generated$Main2165431921$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/Carter/Exercism/elm/sum-of-multiples/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 390124597359833
	},
...
_Platform_export({'Test':{'Generated':{'Main2165431921':{'init':$author$project$Test$Generated$Main2165431921$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-85484.sock";
