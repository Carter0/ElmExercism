...
var $author$project$Triangle$Equilateral = {$: 'Equilateral'};
var $author$project$Triangle$Isosceles = {$: 'Isosceles'};
var $author$project$Triangle$Scalene = {$: 'Scalene'};
...
var $author$project$Triangle$errorChecking = F3(
	function (x, y, z) {
		return ((x <= 0) || ((y <= 0) || (z <= 0))) ? $elm$core$Result$Err('Invalid lengths') : ((!((_Utils_cmp(x + y, z) > 0) && ((_Utils_cmp(x + z, y) > 0) && (_Utils_cmp(y + z, x) > 0)))) ? $elm$core$Result$Err('Violates inequality') : $elm$core$Result$Ok('Valid Triangle'));
	});
var $author$project$Triangle$triangleCheck = F3(
	function (x, y, z) {
		var zEqualsX = _Utils_eq(z, x);
		var yEqualsZ = _Utils_eq(y, z);
		var xEqualsY = _Utils_eq(x, y);
		var _v0 = _Utils_Tuple3(xEqualsY, yEqualsZ, zEqualsX);
		_v0$2:
		while (true) {
			if (_v0.a) {
				if (_v0.b && _v0.c) {
					return $author$project$Triangle$Equilateral;
				} else {
					break _v0$2;
				}
			} else {
				if ((!_v0.b) && (!_v0.c)) {
					return $author$project$Triangle$Scalene;
				} else {
					break _v0$2;
				}
			}
		}
		return $author$project$Triangle$Isosceles;
	});
var $author$project$Triangle$triangleKind = F3(
	function (x, y, z) {
		var _v0 = A3($author$project$Triangle$errorChecking, x, y, z);
		if (_v0.$ === 'Err') {
			var err = _v0.a;
			return $elm$core$Result$Err(err);
		} else {
			return $elm$core$Result$Ok(
				A3($author$project$Triangle$triangleCheck, x, y, z));
		}
	});
		...
		[
			...
			function (_v0) {
				return A2(
					...
					$elm$core$Result$Ok($author$project$Triangle$Equilateral),
					A3($author$project$Triangle$triangleKind, 2, 2, 2));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Ok($author$project$Triangle$Equilateral),
					A3($author$project$Triangle$triangleKind, 10, 10, 10));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v2) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Ok($author$project$Triangle$Isosceles),
					A3($author$project$Triangle$triangleKind, 3, 4, 4));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v3) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Ok($author$project$Triangle$Isosceles),
					A3($author$project$Triangle$triangleKind, 4, 3, 4));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v4) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Ok($author$project$Triangle$Isosceles),
					A3($author$project$Triangle$triangleKind, 4, 4, 3));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v5) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Ok($author$project$Triangle$Isosceles),
					A3($author$project$Triangle$triangleKind, 10, 10, 2));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v6) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Ok($author$project$Triangle$Scalene),
					A3($author$project$Triangle$triangleKind, 3, 4, 5));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v7) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Ok($author$project$Triangle$Scalene),
					A3($author$project$Triangle$triangleKind, 10, 11, 12));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v8) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Ok($author$project$Triangle$Scalene),
					A3($author$project$Triangle$triangleKind, 5, 4, 2));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v9) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Ok($author$project$Triangle$Scalene),
					A3($author$project$Triangle$triangleKind, 0.4, 0.6, 0.3));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v10) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Err('Invalid lengths'),
					A3($author$project$Triangle$triangleKind, 0, 0, 0));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v12) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Err('Violates inequality'),
					A3($author$project$Triangle$triangleKind, 1, 1, 3));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v13) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Err('Violates inequality'),
					A3($author$project$Triangle$triangleKind, 7, 3, 2));
			})
		]));
var $author$project$Test$Generated$Main684570710$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/Carter/Exercism/elm/triangle/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 400468339320477
	},
...
_Platform_export({'Test':{'Generated':{'Main684570710':{'init':$author$project$Test$Generated$Main684570710$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-62702.sock";
